...
CREATE TABLE migration_tr.tr_enhanced_adherence as
  ...
  Pill_count,
  Arv_adherence,
  MMAS4AdherenceRating,
  MMAS4Score,
  MMAS8Score,
  MMAS8AdherenceRating,
  Has_vl_results,
  ...
  Patient_challenges_reaching_clinicScreening,
  Patient_challenges_reaching_clinic,
  Patient_worried_of_accidental_disclosureScreening,
  Patient_worried_of_accidental_disclosure,
  Patient_treated_differentlyScreening,
  Patient_treated_differently,
  Stigma_hinders_adherenceScreening,
  Stigma_hinders_adherence,
  Patient_tried_faith_healingScreening,
