	...
	<div class="main-footer">
		<div class="ed-container">
			<div class="site-info wow zoomIn">
				...
				<?php esc_html_e( 'DevOps : ', 'CICD' );  ?><a  title="<?php echo esc_html_e('Free WordPress Theme','the100');?>" href="<?php echo esc_url( __( 'https://8degreethemes.com/wordpress-themes/the100/', 'the100' ) ); ?>"><?php esc_html_e( '', 'the100' ); ?> </a>
				<span><?php echo esc_html_e(' ','devOps');?></span>
			</div><!-- .site-info -->
			<?php 
