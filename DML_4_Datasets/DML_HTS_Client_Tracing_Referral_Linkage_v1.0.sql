...
,r.CreatedBy
 ...
 pl.HealthWorker as Health_Worker_Handed_To,pl.Cadre,CASE WHEN pl.Enrolled ='1' then pl.LinkageDate end as Date_Enrolled,pl.ArtStartDate,pl.Comments as Remarks,pl.DeleteFlag as Voided,pl.CreateDate,pl.CreatedBy
