...
PL.Cadre Cadre,
Date_Enrolled = (SELECT top 1 PE.EnrollmentDate FROM PatientEnrollment PE INNER JOIN Patient P ON P.Id = PE.PatientId WHERE P.PersonId = PL.PersonId AND ServiceAreaId = 1),
