...
where (pc.DeleteFlag is null or pc.DeleteFlag=0)
 ...
 --select * from  PatientEncounter where PatientMasterVisitId='230791'

-- select  * from PatientEncounter where PatientMasterVisitId='230788'


--select * from LookupItemView where itemId=2028