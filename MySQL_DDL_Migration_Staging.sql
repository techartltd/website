...
CREATE TABLE migration_st.st_mch_delivery (
 ...
 delivery_dischargedate       		date DEFAULT NULL,
 ...
 apgar_5                      		INT(50),
 apgar_10                     		INT(50),
 birthnotificationnumber      		VARCHAR(50),
 birthcomments                		VARCHAR(900),
 test_1_kit_name              		VARCHAR(50),
 ...
 partner_hiv_status           		VARCHAR(50),
 next_hiv_date                		date,
 testedforsyphillis           		VARCHAR(200),
 syphilis_treated             		VARCHAR(50),
 prophylaxis_given            		VARCHAR(50),
 baby_azt_dispensed           		VARCHAR(50),
 baby_nvp_dispensed           		VARCHAR(50),
 [Started HAART MAT]          		VARCHAR(200),
 [Started HAART IN ANC]       		VARCHAR(200),
 [VitaminASupplementation]    		VARCHAR(200),
 clinical_notes               		VARCHAR(200),
 next_appointment_date        		date,
 voided                       		INT(11)INT(11)
);
...
DROP TABLE IF EXISTS st_hei_enrollment;
  CREATE TABLE st_hei_enrollment (
	...
	exit_date_result_collected 			DATE,
    immunization_given 					VARCHAR(100),
	date_immunized 						DATE,
	Date_of_next_appointment			DATE,
	visit_Date 							DATE,
	revisit_this_year 				    VARCHAR(100),
	Primary_care_give					VARCHAR(100),
	Age									VARCHAR(50),
	MUAC								VARCHAR(100),
	Exclusive_breastfeeding_0-6_Months  VARCHAR(100),
	Stunted?                            VARCHAR(100),
	Medication_Given_If_HIV_Expose      VARCHAR(100),
	TB_Assessment_Outcome				VARCHAR(100),
	Development_Milestones_by_ge		VARCHAR(100),
	Achieving_Milestones				VARCHAR(100),
	Weight_Category						VARCHAR(100),
	Type_of_Follow_up					VARCHAR(100),
	Test_Contextual_Status				VARCHAR(100),
	Contextual_Status_Results			VARCHAR(100),
	First_DBS_Sample_Code						VARCHAR(50),
	Date_First_DBS_Sample_Code_Result_collected	DATE,
	First_Antibody-test					VARCHAR(50),
	Date_First_Antibody-test			DATE,
	First_DBS_Sample_Code_Result        VARCHAR(100),
	Final_DBS_Sample_Code				VARCHAR(50),
	Date_Final_DBS_Sample_Code_Result_collected	DATE,
	Final_Antibody-test						VARCHAR(50),
	Date_Final_Antibody-test				DATE,
	Final_DBS_Sample_Code_Result        	VARCHAR(100),
	DBS_Sample_Code							VARCHAR(50),
	Date_DBS_Sample_Code_Result_collected	DATE,
	Tetracycline_Eye_Ointment_(TEO)_Given  	VARCHAR(100),
	PUPIL									VARCHAR(100),
	SIGHT 									VARCHAR(100),
	SQUINT(Crossed_Eyes) 					VARCHAR(100),
	Deworming_and_Vitamin_A_supp			VARCHAR(100),
	Deworming_Next_Visit					DATE,
	Deworming_Drug							VARCHAR(50),
	Deworming_Dosage_Units					VARCHAR(100),
	Vitamin_A								VARCHAR(100),
	Any_disability							VARCHAR(100),
	ClinicianS_Notes						VARCHAR(350),
	Counselled_On							DATE,
	Supplemented_with_MNPS_6-23_Months     	VARCHAR(100),
	Physical features Colouration 			VARCHAR(100),
	Immunization_vaccinine					VARCHAR(100),
	Immunization_Batch_num					VARCHAR(50),
	Immunization_Expiry_Date				DATE,
	Immunization_Dose						VARCHAR(50),
	Immunization_Dte_Given 					DATE,
	Immunization_Date_Of_Next_Visit			DATE,
	Immunization_BCG_ScarChecked			VARCHAR(100),
	Immunization_BCG_Date_Checked			DATE,
	Immunization_BCG_Repeated				VARCHAR(100),
	Immunization_Vitamin_Capsule_Given_Dose  VARCHAR(100),
	Immunization_Vitamin_Capsule_Given       VARCHAR(100),
	Immunization_Vitamin_Capsule_Date_Given  VARCHAR(100),
	Immunization_Vitamin_Capsule_Date_Of_Next_visit  DATE,
	Immunization_Vitamin_Capsule_Fully_Immunized_child VARCHAR(100),
	Immunization_Vitamin_Capsule_Date_Given_Last_Vaccine DATE,
	Child_Hei_Outcomes_Exit_date 			DATE,
	Child_Hei_Outcomes_HIV_Status			VARCHAR(100)
...
CREATE TABLE migration_st.st_hei_followup (
 ...
 TB_Assessment_Outcome				 VARCHAR(100),
 Social_Smile_milestone_<2Months     VARCHAR(100),
 ...
 Response_to_sound_milestone_6months VARCHAR(100),
 ...
 Talking_milestone_36months 		VARCHAR(200) ,
 1st_DNA_PCRSampleDate 		 	    DATE,
 1st_DNA_PCRResult 					VARCHAR(200),
 1st_DNA_PCRResultDate 				DATE,
 2nd_DNA_PCRSampleDate  			DATE,
 2nd_DNA_PCRResult 					VARCHAR(200),
 2nd_DNA_PCRResultDate  			DATE,
 3rd_DNA_PCRSampleDate  			DATE,
 3rd_DNA_PCRResult					VARCHAR(200),
 3rd_DNA_PCRResultDate  			DATE,
 ConfimatoryPCR_SampleDate			DATE,
 ConfirmatoryPCR_Result 			VARCHAR(200),
 ConfimatoryPCR_ResultDate  		DATE,
 RepeatConfirmatoryPCR_SampleDate 	DATE,
 RepeatConfirmatoryPCR_Result		VARCHAR(200),
 RepeatConfirmatoryPCR_ResultDate 	DATE,
 BaselineViralLoadSampleDate  		DATE,
 BaselineViralLoadResult	    	VARCHAR(200),
 BaselineViralLoadResultDate  		DATE,
 Final_AntibodySampleDate    		DATE,
 Final_AntibodyResult 				VARCHAR(200),
 Final_AntibodyResultDate  		 	DATE,
 Dna_pcr_sample_date             	DATE,
 Dna_pcr_contextual_status       	VARCHAR(100),
 Dna_pcr_result                  	VARCHAR(100),
 ...
 ARVProphylaxisReceived 			VARCHAR(100),
 OtherARVProphylaxisReceived  	    VARCHAR(100),
